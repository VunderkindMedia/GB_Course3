...
function showMoreText(card) {
    ...
    const randomText =  `Значимость этих проблем настолько очевидна, 
    что консультация с профессионалами из IT в значительной степени 
    ...
    desc.textContent = randomText;
    desc.classList.add('desc');
    card.wrap.insertBefore(desc, card.img);
